...
Selecting a subset of ukbiobank variables
=========================================

Sometimes we may wish to filter our data based upon a subset of data
...
See the :py:func:`addFields <ukbiobank.utils.ukbio_utils.addFields>` function.
...
Sometimes we may wish to filter our data based upon illness...
...
:download:`This long long long long long long long long long long long long long long long download link should be blue, normal weight text with a leading icon, and should wrap white-spaces <static/UK_biobank_logo.png>`
