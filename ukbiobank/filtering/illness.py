...
def healthy_unhealthy_split(ukbio=None, df=None, instances=[0,1,2,3], return_filter_fields=False):
    """
    Splits dataframe into healthy_df and unhealthy_df based upon exclusion criteria used in Cohen 2020 
   ...
   *Note: According to these criteria, around ~20% of the data are 'healthy', with 80% deemed 'unhealthy'*
    ...
    responses_to_match = [1] # Will collecting eids with response '1' = 'yes' to this field
    ...
    # Filtering those with age stroke diagnosed #4056   (collecting eid for individuals with not any 'non-nan', i.e. containing an age of stroke diagnosis) 
