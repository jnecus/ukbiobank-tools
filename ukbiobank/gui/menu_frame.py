...
class MenuFrame(wx.Frame, ukbiobank.ukbio):
    ...
    def __init__(self, frame, ukb):
        ...
        self.ukb_object = ukb
        self.ukb_object.SELECTIONS = (
            None  # initialising variable/filter selections to None
        )
        ...
        checkbox_btn.Bind(
            wx.EVT_BUTTON,
            lambda evt, ukb=ukb: self.SelectVariablesFrameButton(evt, self.ukb_object),
        )  # for explanation see: https://wiki.wxpython.org/Passing%20Arguments%20to%20Callbacks
        ...
        select_illness_btn.Bind(
            wx.EVT_BUTTON,
            lambda evt, ukb=ukb: self.SelectIllnessFrameButton(evt, self.ukb_object),
        )
        ...
        output_btn.Bind(
            wx.EVT_BUTTON,
            lambda evt, ukb=ukb: self.OutputCsvFrameButton(evt, self.ukb_object),
        )
